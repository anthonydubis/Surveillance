...
+ (ADEvent *)objectForNewEvent
{
  ...
  event.status = ADEventStatusRecording;
...
{
  switch (self.status) {
    case ADEventStatusRecording:
      return @"Still recording...";
    case ADEventStatusWaitingToBeUploaded:
      return @"Waiting to be uploaded...";
    case ADEventStatusUploading:
      return @"Uploading video...";
    case ADEventStatusUploaded:
